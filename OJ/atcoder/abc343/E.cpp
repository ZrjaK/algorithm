...
void solve() {
    INT(V1, V2, V3);
    auto f2 = [&] (int a1, int b1, int c1, int a2, int b2, int c2) -> int {
        int res = 1;
    ...
    auto f3 = [&] (int a1, int b1, int c1, int a2, int b2, int c2, int a3, int b3, int c3) -> int {
        int res = 1;
    ...
    rep(a2, -7, 8) rep(b2, -7, 8) rep(c2, -7, 8) rep(a3, -7, 8) rep(b3, -7, 8) rep(c3, -7, 8) {
        int v3 = f3(0, 0, 0, a2, b2, c2, a3, b3, c3);
        int v2 = f2(0, 0, 0, a2, b2, c2) + f2(0, 0, 0, a3, b3, c3) + f2(a2, b2, c2, a3, b3, c3) - 3 * v3;
