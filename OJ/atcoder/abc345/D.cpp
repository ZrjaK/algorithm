    ...
    auto dfs = [&] (auto dfs, int cur) -> void {
        ...
        rep(i, n) if (!vis[i]) {
            ...
            rep(2) {
                ...
                int ok = 1;
                rep(xx, x, x + a) rep(yy, y, y + b) ok &= X[xx][yy] == 0;
                if (!ok) continue;
                rep(xx, x, x + a) rep(yy, y, y + b) X[xx][yy] = 1;
                vis[i] = 1;
                dfs(dfs, cur + 1);
                rep(xx, x, x + a) rep(yy, y, y + b) X[xx][yy] = 0;
                vis[i] = 0;
            }
        }
    };
