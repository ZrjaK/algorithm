...
void solve() {
    ...
    rep(i, n) {
        ...
        rep(k, K) {
            {
                auto res = matrix_mul<i128, 2>(dp[k], T{A[i], 0, B[i], 1});
                i128 s1 = res[0][0] + res[1][0];
                i128 s2 = ndp[k + 1][0][0] + ndp[k + 1][1][0];
                if (s1 > s2) {
                    ndp[k + 1] = res;
                }
            }
            {
                auto res = matrix_mul<i128, 2>(T{A[i], 0, B[i], 1}, dp[k]);
                i128 s1 = res[0][0] + res[1][0];
                i128 s2 = ndp[k + 1][0][0] + ndp[k + 1][1][0];
                if (s1 > s2) {
                    ndp[k + 1] = res;
