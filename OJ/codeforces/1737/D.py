...
def solve():
    ...
    ans = INF
    for u, v, w in h:
        ans = min(ans, (dist[1][u] + dist[v][n] + 1) * w)
        ans = min(ans, (dist[1][v] + dist[u][n] + 1) * w)
        for i in range(1, n+1):
            ans = min(ans, (dist[1][i] + dist[i][n] + dist[i][u] + 2) * w)
            ans = min(ans, (dist[1][i] + dist[i][n] + dist[i][v] + 2) * w)
    print(ans)
