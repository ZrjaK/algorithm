...
def solve():
    ...
    for i in range(n):
        if s[i] == "1":
            dp[i+1][0][0] = min(dp[i+1][0][0], dp[i][0][0] + aa + 1)
            dp[i+1][0][1] = min(dp[i+1][0][1], dp[i][0][0])
            dp[i+1][1][1] = min(dp[i+1][1][1], dp[i][0][1])
            dp[i+1][1][1] = min(dp[i+1][1][1], dp[i][1][1])
        else:
            dp[i+1][0][0] = min(dp[i+1][0][0], dp[i][0][0])
            dp[i+1][0][1] = min(dp[i+1][0][1], dp[i][0][1] + aa)
            dp[i+1][1][1] = min(dp[i+1][1][1], dp[i][1][1] + aa + 1)
    print(min(min(i) for i in dp[n]))
