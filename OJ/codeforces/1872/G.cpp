...
void solve() {
    INT(n);
    VEC(int, a, n);
    if (SUM<ll>(a) == n) return print(1, 1);
    int l = 0, r = n - 1;
    while (a[l] == 1) l++;
    while (a[r] == 1) r--;
    i128 s = 1;
    ...
    if (s > 1e18) return print(l + 1, r + 1);
    vc<i128> cum1 = {0};
    vc<i128> cum2 = {1};
    each(i, a) cum1.pb(cum1.back() + i), cum2.pb(cum2.back() * i);
    i128 mx = cum2[r + 1] / cum2[l] + cum1[l] + cum1[n] - cum1[r + 1];
    pii ans = {l + 1, r + 1};
    rep(i, len(h)) rep(j, i, len(h)) {
        int l = h[i], r = h[j];
        if (cum2[r + 1] / cum2[l] + cum1[l] + cum1[n] - cum1[r + 1] > mx) {
            mx = cum2[r + 1] / cum2[l] + cum1[l] + cum1[n] - cum1[r + 1];
            ans = {l + 1, r + 1};
        }
    }
    print(ans);
