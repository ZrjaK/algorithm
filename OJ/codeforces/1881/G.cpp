...
mono op(mono a, mono b) {
    ...
    if (b.ok == 2) return a;
    mono c;
    c.l1 = a.l1, c.l2 = a.l2, c.r2 = b.r2, c.r1 = b.r1;
    if (c.l2 == -1) c.l2 = b.l1;
    if (c.r2 == -1) c.r2 = a.r1;
    c.ok = a.ok & b.ok;
    if (a.r2 == b.l1 || a.r1 == b.l2 || a.r1 == b.l1) c.ok = 0;
    return c;
}
...
void solve() {
    INT(n, m);
    STR(s);
    lazy_segtree<mono, op, e, int, mapping, composition, id> seg(n);
    rep(i, n) {
        mono x;
        x.l1 = x.r1 = s[i] - 97;
        x.l2 = x.r2 = -1;
