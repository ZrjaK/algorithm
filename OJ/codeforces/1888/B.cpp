...
void solve() {
    ...
    if (k == 4) {
        if (cnt[0]) return print(0);
        if (cnt[2] >= 2) return print(0);
        if (cnt[3]) return print(1);
        if (cnt[2] && cnt[1]) return print(1);
        if (cnt[2]) return print(2);
        if (cnt[1] >= 2) return print(2);
        print(3);
    }
    if (k == 5) {
        if (cnt[0]) return print(0);
        if (cnt[4]) return print(1);
        if (cnt[3]) return print(2);
        if (cnt[2]) return print(3);
        print(4);
    }
