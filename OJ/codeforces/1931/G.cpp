...
void solve() {
    INT(c1, c2, c3, c4);
    if (c1 + c2 == 0) {
        return print(c3 == 0 || c4 == 0 ? 1 : 0);
    }
    if (abs(c1 - c2) > 1) return print(0);
    if (c1 == c2) {
        mint ans = C<mint>(c1 + c3 - 1, c3) * C<mint>(c1 + c4, c4) + C<mint>(c1 + c3, c3) * C<mint>(c1 + c4 - 1, c4);
        print(ans);
    } else {
        mint ans = C<mint>(max(c1, c2) + c3 - 1, c3) * C<mint>(max(c1, c2) + c4 - 1, c4);
        print(ans);
    }
